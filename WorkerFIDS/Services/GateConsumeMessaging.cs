...
{
    public interface IGateConsumeMessaging
    {
    ...
    public class GateConsumeMessaging
    {
        ...
        public GateConsumeMessaging(IConnection connection, ILogger logger, IDatabase database, WatsonWsServer server, List<Guid> clients)
        {
